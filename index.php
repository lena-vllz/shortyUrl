...
<!-- element (which are displayed on the page when loaded in a browser) -->
  <head>
    <meta charset="utf-8">
    <title>Accueil - Shorty URL</title>
  ...
  <body>
    ...
    <div class="navbar">
        ...
        <!-- Displays the Connexion if u you aren't connected/ Displays the unconnexion if you connected -->
        <ul class="menu">
          <?php
      ...
      <div class="main">
        <div class=sub_container>
          <span class="titre">Raccourcissez vos liens gratuitement à la demande</span>
          <p class="information">Grâce à Shorty URL, raccourcissez vos liens et consultez le nombre de fois où ceux-ci ont été visités.</p>
          <div class="link">
            <!-- The from action goes to short.php -->
            <div class="shorten">
          ...
          if (isset($_SESSION['feedback'])) {
            ...
            echo "<div class='urlcodedisplay'>"."Voici votre ShortyURL : "."<a class='linkshort' href={$feedback}>{$feedback}></a></div>";
          }
          if(isset($_GET['link']))
          {
              $error = ($_GET['link']);
        ...
        <div class="illu">
          <img class="linkPict" src="Assets/anim_illu.gif" />
        </div>
      </div>
