...
<html lang="fr">
  <head>
    <meta charset="utf-8">
    <title>404 error - Shorty URL</title>
  ...
  <body>
    ...
    <div class="conteneur">
      ...
      <svg class="error404" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1920" height="1080" viewBox="0 0 1920 1080">
          <defs>
          <clipPath id="clip-path">
      <rect id="Rectangle_132" data-name="Rectangle 132" width="1920" height="1080" transform="translate(7960 2559)" fill="#fff"/>
    </clipPath>
  </defs>
  <g id="Groupe_de_masques_1" data-name="Groupe de masques 1" transform="translate(-7960 -2559)" clip-path="url(#clip-path)">
    <text id="_404_error" data-name="404 error" transform="matrix(0.951, -0.309, 0.309, 0.951, 7762.847, 3736.122)" fill="#f74d41" font-size="736" font-family="Moret-Regular, Moret" opacity="0.048"><tspan x="0" y="0">404 error</tspan></text>
  </g>
</svg>
      ...
      <div class="text">
        <div class="main">
          <span class="titres">On dirait que vous vous êtes perdu…</span>
          <form action="../index.php" method="POST">
            <button class="connexion" name="submit" type="submit">Retour</button>
          </form>
        </div>
      </div>
    </div>
