<!-- For the connection system (all the files in the inscritption folder), we used this tutorial https://www.youtube.com/watch?v=gCo6JqGMi30 -->
<!-- Starts the session  -->
...
<html lang="fr">
  <head>
    <meta charset="utf-8">
    <title>Inscription - Shorty URL</title>
  ...
  <body>
    ...
    <!-- Set the header -->
      ...
      <div class="navbar">
        ...
        <ul class="menu">
          ...
          if(isset($_SESSION["user"]))
          {
            ...
            echo "<a href='inscription.php'><li class='signup'>Inscription</li></a>";
          }
          ?>
      ...
      <!-- Set the sign up part with the differents inputs -->
        ...
        <div class="main">
          ...
          <p class="texte">Vous avez déjà un compte ? <a class="sign_up_button" href="connexion.php">Connectez-vous</a></p>
          <form action="includes/inscription2.inc.php" method="post">
            <input class="logs" type="text" name="mail" placeholder="Adresse mail"></input>
            <input class="logs" type="text" name="username" placeholder="Nom d'utilisateur"></input>
            <div class="test">
            ...
            <div class="test">
              <input class="logs pwd" type="password" name="repeatPassword" placeholder="Confirmer mot de passe">
                <div class="img">
                  <img class="mdp_hide" src="../assets/hide.png">
                </div>
              </input>
            </div>
            <button class="connexion" type="submit" name="submit">Inscription</button>
          </form>
            ...
            if(isset($_GET["error"]))
            {
              ...
              {
                echo "<p>Les mots de passe ne concordent pas</p>";
              }
              elseif($_GET["error"] == "stmtfailed")
              {
                echo "<p>Quelque chose c'est mal passé... Réessayez !</p>";
              }
    ...
    showPass = false
      const hidePass = document.querySelectorAll('.mdp_hide')
      const test = document.querySelectorAll('.pwd')

      for (let i = 0; i < hidePass.length; i++) {
        hidePass[i].addEventListener('click', () => {
          if (showPass == false) {
            hidePass[i].src = "../assets/hide.png"
            showPass = true
            test[i].type = 'password'
          }
          else if (showPass == true) {
            hidePass[i].src = "../assets/show.png"
            showPass = false
            test[i].type = 'text'
          }
        })
